<x-admin.app title="Azzahra Decoration - Promotions">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Kode Promosi</h1>
            ...
            @foreach ($promotions as $promotion)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('admin.master-data.promotions.edit', $promotion->id) }}" class="btn btn-sm btn-success btn-tooltip" data-toggle="tooltip" data-placement="left" title="Ubah"><i class="fas fa-pencil-alt"></i></a>
