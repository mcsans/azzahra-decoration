            ...
            @foreach ($products as $product)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('admin.master-data.products.edit', $product->id) }}" class="btn btn-sm btn-success btn-tooltip" data-toggle="tooltip" data-placement="left" title="Edit"><i class="fas fa-pencil-alt"></i></a>
