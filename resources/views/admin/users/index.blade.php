            ...
            @foreach ($users as $user)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('admin.master-data.users.edit', $user->id) }}" class="btn btn-sm btn-success btn-tooltip" data-toggle="tooltip" data-placement="left" title="Ubah"><i class="fas fa-pencil-alt"></i></a>
